...
public class BlossomProperty
{
    ...
    {
        Name = parameter.Name ?? parameter.ParameterType.Name;
    ...
    public List<object> GetAvailableValues(Type type) => AvailableValues.Values.Select(x => Convert.ChangeType((object)x, type)).ToList();
