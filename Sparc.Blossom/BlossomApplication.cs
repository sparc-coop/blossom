...
#elif ANDROID
        return new Platforms.Android.BlossomAndroidApplicationBuilder(args ?? []);
#elif IOS
        return new Platforms.iOS.BlossomiOSApplicationBuilder(args ?? []);
#elif WINDOWS
        return new Platforms.Windows.BlossomWindowsApplicationBuilder(args ?? []);
#endif
