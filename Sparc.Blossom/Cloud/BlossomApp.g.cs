...
namespace Sparc.Blossom.Cloud
{
    ...
    public partial interface IBlossomCloud
    {
        /// <returns>OK</returns>
...
namespace Sparc.Blossom.Cloud
{
    ...
    public static partial class IServiceCollectionExtensions
    {
        ...
        {
            var clientBuilderIBlossomCloud = services
                .AddRefitClient<IBlossomCloud>(settings)
                .ConfigureHttpClient(c => c.BaseAddress = baseUrl);

            clientBuilderIBlossomCloud
            ...
            builder?.Invoke(clientBuilderIBlossomCloud);
