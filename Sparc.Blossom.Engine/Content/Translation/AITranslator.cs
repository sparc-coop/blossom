...
internal abstract class AITranslator(BlossomChannels channels, string defaultModel, decimal inputCostPerToken, decimal outputCostPerToken, int priority = 0) : ITranslator
{
