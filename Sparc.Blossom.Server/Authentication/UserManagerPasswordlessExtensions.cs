...
{
    public static async Task<string> CreateMagicSignInLinkAsync<T>(this UserManager<T> manager, string username, string returnUrl) where T : BlossomUser, new()
    {
    ...
    public static async Task<string> CreateMagicSignInLinkAsync<T>(this UserManager<T> manager, T user, string returnUrl) where T : BlossomUser, new()
    {
