...
public class BlossomMauiAuthorizationMessageHandler : DelegatingHandler, IDisposable
{
    ...
    public BlossomMauiAuthorizationMessageHandler(IAccessTokenProvider provider, string? baseUrl)
    {
        _provider = provider;
    ...
    protected override async Task<HttpResponseMessage> SendAsync(HttpRequestMessage request, CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidOperationException($"The '{nameof(BlossomMauiAuthorizationMessageHandler)}' is not configured. " +
                $"Call '{nameof(BlossomMauiAuthorizationMessageHandler.ConfigureHandler)}' and provide a list of endpoint urls to attach the token to.");
        }
    ...
    public BlossomMauiAuthorizationMessageHandler ConfigureHandler(IEnumerable<string?> authorizedUrls, IEnumerable<string>? scopes = null, string? returnUrl = null)
    {
        if (_authorizedUris != null)
        {
